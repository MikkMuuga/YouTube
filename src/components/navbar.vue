...
<template>
  <nav class="bg-[#0f0f0f] text-white px-4 h-14 flex items-center justify-between sticky top-0 z-50">
    ...
    <div class="flex items-center gap-2">
      <button class="flex items-center gap-2 hover:bg-white/10 px-3 py-1.5 rounded-full text-sm font-medium transition">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
